...
GROOVEMIDI_FILTER_TEMPLATE = [{
    ...
    "number_of_samples": None,                          # [(n_samples_lower_bound, n_samples_upper_bound), ...,
                                                        #  (n_samples_lower_bound, n_samples_upper_bound)]
    ...
    "reject_empty_instruments": None                    # ["kick", "snare", "closed hihat", "open hihat", "ride",
                                                        # "crash", "extra cymbal", "low tom", "mid tom", "high tom"]
